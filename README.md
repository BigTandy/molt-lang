...
| -------- | -------------- | ------------------ | -------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `+`      | Addition       |                    | `3 + 2 = 5`                      | Adds two numbers together.                                                                                 |
| `-`      | Subtraction    |                    | `2 - 1 = 1`, `{2,1} - {1} = {2}` | When given two numbers, is the subtraction operation. When given two sets, it is the difference operation. |
| `*`      | Multiplication |                    |                                  |                                                                                                            |
### Values
